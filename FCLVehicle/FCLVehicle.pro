...
unrealRootPath=/home/paul/Dev/UnrealEngine
FCLVehicleRootPath=/home/paul/Documents/Unreal Projects/FCLVehicle

gameProjectFile=/home/paul/Documents/Unreal Projects/FCLVehicle/FCLVehicle.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(FCLVehicleSource.pri)
include(FCLVehicleHeader.pri)
include(FCLVehicleConfig.pri)
include(FCLVehicleIncludes.pri)
include(FCLVehicleDefines.pri)
...
FCLVehicle-Linux-Debug.commands = $$build FCLVehicle Linux Debug  -project="\"$$gameProjectFile\"" $$args
FCLVehicle-Linux-DebugGame.commands = $$build FCLVehicle Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
FCLVehicle-Linux-Shipping.commands = $$build FCLVehicle Linux Shipping  -project="\"$$gameProjectFile\"" $$args
FCLVehicle-Linux-Test.commands = $$build FCLVehicle Linux Test  -project="\"$$gameProjectFile\"" $$args
FCLVehicle.commands = $$build FCLVehicle Linux Development  -project="\"$$gameProjectFile\"" $$args

FCLVehicleEditor-Linux-Debug.commands = $$build FCLVehicleEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
FCLVehicleEditor-Linux-DebugGame.commands = $$build FCLVehicleEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
FCLVehicleEditor-Linux-Shipping.commands = $$build FCLVehicleEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
FCLVehicleEditor-Linux-Test.commands = $$build FCLVehicleEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
FCLVehicleEditor.commands = $$build FCLVehicleEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	FCLVehicle-Linux-Debug \
	FCLVehicle-Linux-DebugGame \
	FCLVehicle-Linux-Shipping \
	FCLVehicle-Linux-Test \
	FCLVehicle \
	FCLVehicleEditor-Linux-Debug \
	FCLVehicleEditor-Linux-DebugGame \
	FCLVehicleEditor-Linux-Shipping \
	FCLVehicleEditor-Linux-Test \
	FCLVehicleEditor \
